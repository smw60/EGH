...
namespace EGH01.Controllers
{
    public class EGHRGEController : Controller
    {
        ...
        {
            if (db.IsConnect) ViewBag.msg = "соединение  c БД 6 не установлено";
            else ViewBag.msg = "соединение  c БД 6 не установлено";
       ...
       ИнформацияИзБД.AppendChild(ПаспортныеДанные);
        ...
        public ActionResult Report()
        {
            ...
            else ViewBag.msg = "соединение  c <i>БД  не</i> установлено";
