...
---- ¬ставка первоначальных данных в таблицу -- ќпорна€ √еологическа€ “очка
...
---- ¬ставка первоначальных данных в таблицу -- “ехногенный объект
INSERT INTO	[dbo].[“ехногенныйќбъект](
					...
					[√лубина√рунтовых¬од],
					[¬ысота”ровнемћор€]) 
		VALUES(4, 1, 1, 'ј«—-29', 'г. √омель, ул. —троителей, 27', 27.5, 56.9, 1, 12.3, 16.2);
GO
...
GO
---- ¬ставка первоначальных данных в таблицу -- ѕриродоохранные объекты
INSERT INTO [dbo].[ѕриродоохранныйќбъект] 
					([Idѕриродоохранногоќбъекта],
					 [Ќаименованиеѕриродоохранногоќбъекта],
					 [ од“ипаѕриродоохранногоќбъекта],
					 [ од“ипаЌазначени€«емель],
					 [Ўирота√рад],
					 [ƒолгота√рад],
					 [“ип√рунта],
					 [√лубина√рунтовых¬од],
					 [¬ысота”ровнемћор€] ) 
	VALUES(1,'Ѕеловежска€ пуща', 3, 5, 27.7, 56.8, 1, 2.3, 8.9);
GO
...
---- ¬ставка первоначальных данных в таблицу -- »нцидент 
---------------------- ”точнить данные дл€ вставки!!!!
INSERT INTO [dbo].[»нцидент](
				[Id»нцидента],
				[ од“ипа»нцидента],
				[ƒата],
				[ƒата—ообщени€],
