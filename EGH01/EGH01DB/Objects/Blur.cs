...
namespace EGH01DB.Objects
{
    ...
    public class WaterBlur           //  водное пятно -  пятно нефтеродукта c грунтовыми водами  
    {
        ...
        public EcoObjectsList riskobjecstlist { get; private set; }  // список  доп. объектов входящих в водяное пятно      
        ...
        public WaterBlur(GroundBlur groundblur)
        {
            ...
            this.riskobjecstlist = EcoObjectsList.CreateRiskObjectsList(groudblur.center, groudblur.radius, radius);
